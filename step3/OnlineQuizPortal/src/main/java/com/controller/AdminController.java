...
public class AdminController {
	...
	@PatchMapping(value = "modifyQuestion",consumes = MediaType.APPLICATION_JSON_VALUE)
	public String updateQuestion(@RequestBody Question qn) {
		return adminService.updateQuestion(qn);
	}
	@PatchMapping(value = "modifyQuiz",consumes = MediaType.APPLICATION_JSON_VALUE)
	public String updateQuiz(@RequestBody Quiz qz) {
		return adminService.updateQuiz(qz);
	}
