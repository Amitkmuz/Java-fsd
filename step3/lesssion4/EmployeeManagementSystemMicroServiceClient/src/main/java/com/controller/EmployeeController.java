...
//htttp;//localhost:8383/employees
...
public class EmployeeController {
	...
	//htttp;//localhost:8383/employees/findAll
	
	//@RequestMapping(value="findAll",method=RequestMethod.GET,produces=MediaType.APLLICATION_JSON_VALUE)
